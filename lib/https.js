...
let pem_privateKey  = process.env.PEM_PRIVATEKEY || '/root/smart-receipt/ssl/privkey.pem';
let pem_certificate = process.env.PEM_CERT       || '/root/smart-receipt/ssl/cert.pem'   ;
let pem_ca          = process.env.PEM_CHAIN      || '/root/smart-receipt/ssl/chain.pem'  ;
